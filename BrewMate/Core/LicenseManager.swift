...
final class LicenseManager {
    ...
    /// Purchase URL - Update this with your actual LemonSqueezy checkout URL
    static let purchaseURL = URL(string: "https://multimodal.lemonsqueezy.com/checkout/buy/36a71ea0-950d-47c2-b697-d55adbb17b7a")!
    ...
    private enum DefaultsKeys {
        static let trialStartDate = "brewmate.trialStartDate"
        static let lastValidationDate = "brewmate.lastValidationDate"
    }
    ...
    func activateLicense(key: String) async throws {
        ...
        let instanceName = Host.current().localizedName ?? "BrewMate-Mac"
