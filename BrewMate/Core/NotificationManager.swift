...
/// Manages local notifications for BrewMate
@MainActor
final class NotificationManager: NSObject, ObservableObject {
    ...
    private enum NotificationIdentifier {
        static let updatesAvailable = "com.brewmate.updates.available"
        static let autoUpgradeComplete = "com.brewmate.autoupgrade.complete"
    }
