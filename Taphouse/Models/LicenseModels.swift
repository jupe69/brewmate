...
enum LicenseError: LocalizedError {
    ...
    var recoverySuggestion: String? {
        ...
        case .trialExpired:
            return "Purchase Taphouse Pro to continue using all features."
        case .noLicense:
...
enum ProFeature: String, CaseIterable, Identifiable {
    ...
    case appStore = "App Store Integration"
    ...
    var description: String {
        ...
        case .appStore:
            return "Manage Mac App Store apps alongside Homebrew with mas CLI integration."
        }
    }
