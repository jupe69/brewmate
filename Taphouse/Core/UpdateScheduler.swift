...
final class UpdateScheduler: ObservableObject {
    ...
    private func getLogFileURL() -> URL? {
        ...
        if !FileManager.default.fileExists(atPath: taphouseDir.path) {
            try? FileManager.default.createDirectory(at: taphouseDir, withIntermediateDirectories: true)
        }

        return taphouseDir.appendingPathComponent("upgrade_history.log")
    }
}
